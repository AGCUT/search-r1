...
# 测试样本数（默认: 2000条随机样本）
# 如果想测试全部样本，改为: data.val_data_num=null
...
# 改为你想要的数量:
data.val_data_num=5000    # 测试 5000 条
data.val_data_num=null    # 测试全部 16,451 条
data.val_data_num=500     # 快速测试 500 条
```
