...
export TRAIN_DATASET_PATH=$PROJECT_ROOT/ccks2025_pdf_multimodal/round_b/train_b_dataset_for_image_0801.jsonl
...
# 注意: 由于只有5张GPU（而非原始的8张），有效batch size会从128降低到80
# 如果想保持相同的有效batch size，可以增加gradient_accumulation_steps到26
